...
<nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" style="background-color: black;"
    role="navigation">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="dropup"><a class="dropup-toggle" href="/user/userProfile" data-toggle="dropup">내
                                정보</a></li>
            ...
            <div>
                <span style="position: absolute; right: 10px;"> <a class="dropup-toggle" href="/user/userProfile"
                        data-toggle="dropup">
                        <c:choose>
