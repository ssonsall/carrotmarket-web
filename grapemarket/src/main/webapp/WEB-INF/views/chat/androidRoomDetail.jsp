...
<body>
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="list-group-item2"><span class="test_item2">
									<a onclick="messageReportPopup(${message.id}); return false">
										${message.message} </a>
							</span></li>
						</c:otherwise>
					</c:choose>
    ...
    var popupY = (window.screen.height / 2) - (600 / 2);
    	function messageReportPopup(id) {
            window.open("/report/androidReportForm?id=" + id + "&type=message", "a", "width=500, height=600, left="+popupX+", top="+popupY);
        }
