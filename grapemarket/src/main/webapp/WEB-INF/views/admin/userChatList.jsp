    ...
    <div id="modal" class="searchModal">
        <div class="modal-box">
            ...
            <div style="width: auto;">
                <button class="btn btn-danger" onclick="changeRoleToAdmin(${user.id},'${user.role}')">ADMIN
                    으로 변경</button>
                <button class="btn btn-info" onclick="changeRoleToUser(${user.id},'${user.role}')">USER
                    로 변경</button>
                            ...
                            <tbody>
                                <c:forEach var="message" items="${messages}">
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <c:if test="${message.user.id ne report.user.id }">
                                                ${message.message }
                                            </c:if>
                                        </td>

                                        <td style="text-align: center; margin: auto;"><button
                                                onclick="messageReportPopup(${message.id})" class="btn btn-danger">
