            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="tables.html"><i class="icon-chevron-right"></i> User</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><span class="badge badge-success pull-right">731</span> Product</a>
                        </li>
                        <li>
                            <a href="#"><span class="badge badge-success pull-right">812</span> Deal</a>
                        </li>
                        <li>
                            <a href="#"><span class="badge badge-warning pull-right">4,231</span> Chats</a>
                        </li>
                        <li>
                            <a href="#"><span class="badge badge-important pull-right">83</span> Report</a>
                        </li>
                    </ul>
                </div>
                <!--/span-->
