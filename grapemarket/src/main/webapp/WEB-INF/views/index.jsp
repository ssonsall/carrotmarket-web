											...
											<form id="subscription-form" role="form" method="post" action="php/subscribe.php">
												<div class="input-group col-sm-8 col-md-5 col-lg-5" style="float: none; margin: 0 auto">
													<input class="form-control" type="email" id="semail" name="semail" placeholder="검색어를 입력하세요"
														...
														<button class="btn btn-g btn-round" id="subscription-form-submit" type="submit">검색</button>
													</span>
												</div>
											</form>
										</div>
					...
					<div class="row">
						<div class="owl-carousel text-center" data-items="5" data-pagination="false" data-navigation="false">
							...
							<div class="owl-item">
								<div class="col-sm-12">
									<div class="ex-product">
										<a href="#"><img src="assets/images/shop/product-2.jpg" alt="Derby shoes" /></a>
										<h4 class="shop-item-title font-alt">
							...
							<div class="owl-item">
								<div class="col-sm-12">
									<div class="ex-product">
										<a href="#"><img src="assets/images/shop/product-3.jpg" alt="Leather belt" /></a>
										<h4 class="shop-item-title font-alt">
											<a href="#">Leather belt</a>
										</h4>
										£19.00
