								...
								<div style="margin-left: 15%;">
									<div class="col-sm-12 col-md-6 col-lg-6" style="float: left;">
										<div class="font-alt mb-30 titan-title-size-1">This is
											502</div>
										<div class="font-alt mb-30 titan-title-size-4">PoDo
											Market</div>
										<div class="font-alt mb-40 titan-title-size-1">Your
											online fashion destination</div>
										<div class="font-alt">
											<form id="subscription-form" role="form" method="post"
												action="php/subscribe.php">
												<div class="input-group col-sm-8 col-md-5 col-lg-5"
													style="float: none; margin: 0 auto">
													<input class="form-control" type="email" id="semail"
														name="semail" placeholder="검색어를 입력하세요"
														data-validation-required-message="Please enter your email address."
														required="required" /><span class="input-group-btn">
														<button class="btn btn-g btn-round"
															id="subscription-form-submit" type="submit">검색</button>
													</span>
												</div>
											</form>
										</div>
									...
									<div class="col-sm-6 col-md-3 col-lg-3"
										...
										<c:forEach var="item" items="${searchs}" varStatus="status">
											<h3>${status.count}:${item.content}</h3>
										</c:forEach>
									</div>
								</div>
							</div>
		...
		<div class="main">
			...
			<section class="module module-video bg-dark-30"
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<h2 class="module-title font-alt mb-0">Be inspired. Get
								ahead of trends.</h2>
						</div>
					</div>
				</div>
					...
					<div class="row multi-columns-row post-columns wo-border">
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="post mb-40">
								...
								<div class="post-entry">
									<p>당근에서 거래하는 재미에 쏙 빠졌어요~ 안쓰는 물건 나눔하고 피드백 받는 경험도 너무 좋았어요~
										동네라서 정말 편해요. 넘나 애정하는 어플 응원할게요!</p>
								</div>
								<div class="post-more">
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="post mb-40">
								...
								<div class="post-entry">
									<p>요즘 미니멀라이프 실천 중인데 당근마켓만한 앱이 없어요! 미니멀리즘을 위한 앱이랄까요?ㅎㅎ 동네
										직거래라 쉽고 간편해서 너무 좋아요^^ 중고거래에 빠져있답니다❤︎</p>
								</div>
								<div class="post-more">
									<a class="more-link" href="#">Read more</a>
								</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="post mb-40">
								...
								<div class="post-entry">
									<p>요즘 매일 쓰는 벼룩 앱이에요:) 근처 주민이라 믿을만하고 쉽게 거래할 수 있어요~ 동네에서 올라오는
										매물 구경하는 맛에 완전 중독됐어요!! 진짜 안써본 사람은 몰라요 ㅋㅋ</p>
								</div>
								<div class="post-more">
									<a class="more-link" href="#">Read more</a>
								</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="post mb-40">
								...
								<div class="post-entry">
									<p>집에 있는 안 쓰는 물건 팔기 좋아요 :) 동네 사람들이랑 직거래할 수 있어서 소소한 물건 팔기
										좋아요!</p>
								</div>
								<div class="post-more">
									<a class="more-link" href="#">Read more</a>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="post mb-40">
								...
								<div class="post-entry">
									<p>근처에 있는 사람들끼리 거래하니까 뭔가 더 믿을 수 있는 것 같아요. 동네에서 바로 직거래할 수 있는
										물건만 볼 수 있어 좋은 것 같아요.</p>
								</div>
								<div class="post-more">
									<a class="more-link" href="#">Read more</a>
								</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="post mb-40">
								...
								<div class="post-entry">
									<p>아나바다 운동하는 것 같아서 좋아요ㅎ 저한텐 필요 없는 물건이 필요한 사람에게 전달될 수 있는 공간을
										열어주셔서 감사합니다!</p>
								</div>
								<div class="post-more">
									<a class="more-link" href="#">Read more</a>
