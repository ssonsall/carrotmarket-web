...
<body data-spy="scroll" data-target=".onpage-navigation"
		...
		<div class="main">
			<section class="module" id="contact">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3">
							<form id="writeFormSubmit" action="/board/writeProc" method="post" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                        ...
                        <div id="photo">
                              <div class="form-group" id="productImage1">
                                 ...
                                 <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage1" required="required"
                           ...
                           <c:if test="${!empty board.image2}">
                              <div class="form-group" id="productImage2">
                                 <label class="sr-only" for="price">사진</label> 
                                 <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage2"
                           ...
                           <c:if test="${!empty board.image3}">
                              <div class="form-group" id="productImage3">
                                 <label class="sr-only" for="price">사진</label> 
                                 <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage3"
                           ...
                           <c:if test="${!empty board.image4}">
                              <div class="form-group" id="productImage4">
                                 <label class="sr-only" for="price">사진</label> 
                                 <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage4"
                           ...
                           <c:if test="${!empty board.image5}">
                              <div class="form-group" id="productImage5">
                                 <label class="sr-only" for="price">사진</label> 
                                 <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage5"
   ...
   <script type="text/javascript">
      ...
      $('#writeFormSubmit').submit(function fillPhoto() {
                     if (!document.getElementById("productImage1")) {
