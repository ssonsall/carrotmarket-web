                  ...
                  <div class="col-sm-6 col-sm-offset-3">
                     <form id="updateForm" action="/board/update" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="state" value="0"> <input type="hidden" name="id" value="${board.id}"> <input type="hidden"
                           id="currentImage1" name="currentImage1" value="${board.image1}"> <input type="hidden" id="currentImage2" name="currentImage2" value="${board.image2}"> <input
                           type="hidden" id="currentImage3" name="currentImage3" value="${board.image3}"> <input type="hidden" id="currentImage4" name="currentImage4" value="${board.image4}">
                        <input type="hidden" id="currentImage5" name="currentImage5" value="${board.image5}">
                        ...
                        <!-- 사진 시작 -->
                        <div style="margin-bottom: 10px;" type="button" onclick="plusPhoto();savePhoto();"><i class="fa fa-plus-circle"> 사진추가</i></div>

                        <div id="photo">
                           <c:if test="${board.image1 ne ''}">
                              <div class="form-group" id="productImage1">
                                 <label class="sr-only" for="price">사진</label> 
                                 <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage1"
                                    name="productImage1" data-validation-required-message="Please enter your email address." />
                           ...
                           <c:if test="${board.image2 ne ''}">
                              <div class="form-group" id="productImage2">
                                 <label class="sr-only" for="price">사진</label> <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage2"
                                    name="productImage2" data-validation-required-message="Please enter your email address." />
                                <div style="display: inline;" type='button' onclick='deletePhoto(2)'><i class="fa fa-minus-circle">사진삭제</i></div>
                           ...
                           <c:if test="${board.image3 ne ''}">
                              <div class="form-group" id="productImage3">
                                 <label class="sr-only" for="price">사진</label> <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage3"
                                    name="productImage3" data-validation-required-message="Please enter your email address."  />
                                 <div style="display: inline;" type='button' onclick='deletePhoto(3)'><i class="fa fa-minus-circle">사진삭제</i></div>
                           ...
                           <c:if test="${board.image4 ne ''}">
                              <div class="form-group" id="productImage4">
                                 <label class="sr-only" for="price">사진</label> <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage4"
                                    name="productImage4" data-validation-required-message="Please enter your email address." />
                                <div style="display: inline;" type='button' onclick='deletePhoto(4)'><i class="fa fa-minus-circle">사진삭제</i></div>
                           ...
                           <c:if test="${board.image5 ne ''}">
                              <div class="form-group" id="productImage5">
                                 <label class="sr-only" for="price">사진</label> <input style="display: inline;" class="inputfile" type="file" accept="image/*" id="productImage5"
                                    name="productImage5" data-validation-required-message="Please enter your email address." />
                                 <div style="display: inline;" type='button' onclick='deletePhoto(5)'><i class="fa fa-minus-circle">사진삭제</i></div>
