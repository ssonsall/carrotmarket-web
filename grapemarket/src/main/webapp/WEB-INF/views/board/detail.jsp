            ...
            <div class="row">
              ...
              <div class="col-sm-6 mb-sm-40"><a class="gallery" href="assets/images/shop/product-7.jpg"><img src="assets/images/shop/product-7.jpg" alt="Single Product Image"/></a>
                ...
                <ul class="product-gallery">
                  ...
                  <li><a class="gallery" href="assets/images/shop/product-10.jpg"></a><img src="assets/images/shop/product-7.jpg" alt="Single Product"/></li>
            ...
            <div class="row mt-70">
              <div class="col-sm-12">
                <ul class="nav nav-tabs font-alt" role="tablist">
                  <li class="active"><a href="#reviews" data-toggle="tab"><span class="icon-tools-2"></span>ëê¸ (2)</a></li>
                </ul>
                <!-- ëê¸ êµ¬ì­ ìì-->
