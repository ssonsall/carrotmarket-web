					...
					<div class="row">
						...
						<div class="col-sm-6 mb-sm-40">
							<img style="width: 555px; height: 625.94px;" id="mainImage"
								src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image1}" alt="Single Product Image" />
							<!-- ìí ìì ì¬ì§ ìì-->
							<ul class="product-gallery">
								<li><img style="width: 83.25px; height: 93.89px;" id="img1"
									onClick="changeImg(1)" src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image1}"
									alt=" No Image" /></li>
								<c:if test="${!empty board.image2}">
									<li><img style="width: 83.25px; height: 93.89px;"
										id="img2" onClick="changeImg(2)" src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image2}"
										alt=" No Image" /></li>
								</c:if>
								<c:if test="${!empty board.image3}">
									<li><img style="width: 83.25px; height: 93.89px;"
										id="img2" onClick="changeImg(3)" src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image3}"
										alt=" No Image" /></li>
								</c:if>
								<c:if test="${!empty board.image4}">
									<li><img style="width: 83.25px; height: 93.89px;"
										id="img2" onClick="changeImg(4)" src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image4}"
										alt=" No Image" /></li>
								</c:if>
								<c:if test="${!empty board.image5}">
									<li><img style="width: 83.25px; height: 93.89px;"
										id="img2" onClick="changeImg(5)" src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image5}"
										alt=" No Image" /></li>
								</c:if>

								<!-- 								<li><img style="width: 83.25px; height: 93.89px;" id="img3" onClick="changeImg(3)"
									src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image3}" alt=" No Image" /></li>
								<li><img style="width: 83.25px; height: 93.89px;" id="img4" onClick="changeImg(4)"
									src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image4}" alt=" No Image" /></li>
								<li><img style="width: 83.25px; height: 93.89px;" id="img5" onClick="changeImg(5)"
									src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image5}" alt="" /></li> -->
							</ul>
							...
							<script>
                                function changeImg(id) {
                                    ...
                                    if (id == 1) {
                                        img.src = "/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image1}";
                                    } else if (id == 2) {
                                        img.src = "/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image2}";
                                    } else if (id == 3) {
                                        img.src = "/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image3}";
                                    } else if (id == 4) {
                                        img.src = "/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image4}";
                                    } else if (id == 5) {
                                        img.src = "/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${board.image5}";
                                    }
								...
								<c:forEach var="comment" items="${comments}">
									...
									<div id="comment_id_${comment.id}" class="comment clearfix">
										<div class="comment-avatar">
											<img src="/home/ubuntu/grapemarket-web/grapemarket/src/main/resources/static/upload/${comment.user.userProfile}" alt="avatar" />
										</div>
