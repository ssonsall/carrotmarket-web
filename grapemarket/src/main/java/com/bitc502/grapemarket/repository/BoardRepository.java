...
public interface BoardRepository extends JpaRepository<Board, Integer>, JpaSpecificationExecutor<Board> {
   ...
   void update(String state, int category, String title, String price, String content, String image1, String image2, String image3, String image4, String image5, int id);
