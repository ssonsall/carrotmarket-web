package com.bitc502.grapemarket.security.oauth2;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService implements UserDetailsService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        User user = new User();
        System.out.println("custom provider id"+oAuth2UserRequest.getClientRegistration().getRegistrationId());
    ...
    private User updateExistingUser(User existingUser, OAuth2UserInfo oAuth2UserInfo) {
        ...
        existingUser.setUserProfile(oAuth2UserInfo.getImageUrl());
